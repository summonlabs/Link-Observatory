# Strict, first-party-only warning configuration for every Link Observatory target.
#
...
function(linkobs_apply_warnings target)
  if(MSVC)
    ...
    if(LINKOBS_WARNINGS_AS_ERRORS)
      target_compile_options(${target} PRIVATE /WX)
    endif()
    if(LINKOBS_ENABLE_ANALYZE)
  ...
  if(LINKOBS_SANITIZE)
    if(MSVC)
      target_compile_options(${target} PRIVATE "/fsanitize=${LINKOBS_SANITIZE}")
    else()
      target_compile_options(${target} PRIVATE "-fsanitize=${LINKOBS_SANITIZE}" -fno-omit-frame-pointer)
      target_link_options(${target} PRIVATE "-fsanitize=${LINKOBS_SANITIZE}")
    endif()
  endif()
endfunction()
